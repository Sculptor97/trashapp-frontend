      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {APP_CONFIG.pricing.plans.map((plan) => (
            <Card key={plan.name} className={`border-2 ${plan.popular ? 'border-brand-primary' : 'border-gray-200 hover:border-brand-primary'} transition-colors relative`}>
              {plan.popular && (
              ...
              <CardHeader className="text-center">
                ...
                <div className="space-y-2">
                  <div className="text-4xl font-bold text-brand-primary">{plan.price} {plan.currency}</div>
